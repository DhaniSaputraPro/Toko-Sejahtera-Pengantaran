    ...
    <div className="isi">
      <div className="kartu">
        ...
        <div className="baris" style={{ gap: 8, marginTop: 12 }}>
          ...
          {/* Hijau hanya kalau memang ada yang selesai. Nol berlencana hijau
              memberi selamat atas sesuatu yang belum terjadi. */}
          <span className={`lencana angka ${hariIni.length > 0 ? "lencana-hijau" : "lencana-abu"}`}>
            {hariIni.length} selesai hari ini
          </span>
        </div>
      </div>
      ...
      {riwayat === null && !galat ? (
        ...
        >
          ...
          <div className="lembut">Belum ada yang selesai.</div>
        </div>
      ) : (
        (riwayat ?? []).map((r) => (
